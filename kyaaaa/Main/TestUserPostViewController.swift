//
//  TestUserPostViewController.swift
//  kyaaaa
//
//  Created by 齋藤律哉 on 2020/03/05.
...
class TestUserPostViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TimeLineTableViewCellDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.ageLabel.text = test[indexPath.row]
